        ...
        success: function (respuesta) {
            ...
            respuesta.forEach(function(element, index) {
                ...
                tabla.row.add([
                    ...
                    '<div class="form-group"><button class="btn btn-sm btn-primary" style="color:white;border-radius:20px;width:90%" data-toggle="modal" title="Registrado" data-target="#modalVer" onclick="mostrarById(' + element.id + ')">Registrado</button></div>'
                ]).draw(false);
            })
        }
