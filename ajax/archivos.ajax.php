...
define('DIR_DESCARGAS', __DIR__ . DIRECTORY_SEPARATOR . '../img/usuarios/' . $_SESSION["usuario"]);
// Obtenemos el array de ficheros enviados
$ficheros = $_FILES['logArchivo'];
...
// Si la carpeta existe y tiene datos se borran los archivos
$files = glob(DIR_DESCARGAS . '/*'); //obtenemos todos los nombres de los ficheros
